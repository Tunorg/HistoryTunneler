...
# TODO: т.к. большиство типов можно было интегрировать в их класс,
# то отдельный модуль Type под такие типы уже не нужен. Тип Human и Hero
# думаю, лучше перенести в модуль ClassPersonage, а данный модуль удалить.
